...
import { listFilesTool } from './tools/987c58a5-d9cc-428c-bbda-6263603021a2.mjs';
import { makeDirTool } from './tools/ffc05149-6aba-4f2e-ad43-5f82b32b3c4e.mjs';
import { readFileTool } from './tools/62c26169-36ed-4931-811e-5b5f1bb69e44.mjs';
import { removeFileTool } from './tools/7adf7f4a-4ddd-454a-889e-1ec94e4f7fc3.mjs';
import { renameFileTool } from './tools/6fb39c75-3c4b-4c37-b710-a31d19a5b2ff.mjs';
import { terminalTool } from './tools/285ceabe-b5b0-4903-a775-6a0ff3883fd1.mjs';
import { writeFileTool } from './tools/da46c5b5-adf9-45b3-975c-4f45b3c3b5ca.mjs';
import { NewAgentNetwork } from '@mastra/core/network/vNext';
import { Memory } from '@mastra/memory';
import { e as env } from './utils.mjs';
import Sandbox from '@e2b/code-interpreter';
import { createWorkflow, createStep, generateEmptyFromSchema, Telemetry } from '@mastra/core';
...
const summarizingUserRequestAgent = new Agent({
...
const setupEnvironment = createStep({
  ...
  execute: async ({ inputData }) => {
    ...
    const summarizedInputRequest = await summarizingUserRequestAgent.generate(input);
    const sandbox = await Sandbox.create("sagent-nextjs", {
      timeoutMs: 1e3 * 60 * 60,
      // 1 hour
      apiKey: env.E2B_API_KEY
    });
    const host = sandbox.getHost(3e3);
...
const codingNetwork = new NewAgentNetwork({
  id: "coding-network",
  name: "Coding Network",
  instructions: PROMPT.SYSTEM,
