              ...
              <FormField
                ...
                render={({ field }) => (
                  <Textarea
                    ...
                    className="field-sizing-content h-fit max-h-40 min-h-18 resize-none border-none bg-transparent p-2 shadow-none outline-none focus-visible:ring-0 dark:bg-transparent"
